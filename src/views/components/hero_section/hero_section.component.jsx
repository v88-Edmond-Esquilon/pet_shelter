...
export default function Hero_Section() {
    ...
    const clicked_edit_pet = useSelector(state => state.page.clicked_edit_pet.status);
    ...
    return (
        <>
            ...
            <p className={`sub_header_title ${clicked_add_pet || clicked_edit_pet? "inactive" : ""}`}>These pets are looking for a good home</p>
        </>
    )
}
